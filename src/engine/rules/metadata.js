...
export const RULE_META = {
  ...
  'dependabot-insecure-execution':   { owasp: 'CICD-SEC-3', confidence: 'CONFIRMED' },
  'dependabot-confused-deputy':      { owasp: 'CICD-SEC-2', confidence: 'HIGH'      },
  'hardcoded-container-credentials': { owasp: 'CICD-SEC-6', confidence: 'HIGH'      },
  'id-token-write-unscoped':         { owasp: 'CICD-SEC-5', confidence: 'HIGH'      },
  'pr-runs-on-self-hosted':          { owasp: 'CICD-SEC-7', confidence: 'CONFIRMED' },
  'overprovisioned-secrets':         { owasp: 'CICD-SEC-6', confidence: 'HIGH'      },
};
