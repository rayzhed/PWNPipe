...
import { calculateScore, countsBySeverity } from '@/utils/scoring.js';
import {
  buildMarkdownReport,
  buildSarif,
  buildCsv,
...
import { useFindings, isGroupScoreable } from '@/hooks/useFindings.js';
          ...
          {findings.length > 0 && (
            <div data-print-hide className="sticky top-0 z-10 -mx-5 mb-4 border-b border-border/30 bg-background/95 px-5 pb-3 pt-2 backdrop-blur-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                {/* Group-by toggle — always pinned to the right */}
